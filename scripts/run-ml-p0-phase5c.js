...
async function scanRemoteInventory(token) {
  ...
  const items = [];
  const fields = 'id,title,family_name,family_id,status,sub_status,seller_id,seller_custom_field,user_product_id,catalog_product_id,category_id,attributes,variations,price,available_quantity,sold_quantity,listing_type_id,catalog_listing,permalink,date_created,last_updated';
