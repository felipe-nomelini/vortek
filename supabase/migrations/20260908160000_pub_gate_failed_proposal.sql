-- A proven pre-send failure may be proposed again, but never reuses a consumed approval.
-- Requested/inconclusive operations keep their identity and remain reconciliation-only.
