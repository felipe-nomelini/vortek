...
- O link público da DANFE enviado em `nfe.url` entrega o PDF diretamente pelo domínio `app.bentevi.shop`. O serviço lê o arquivo no Storage privado; não redireciona o fornecedor para o endereço interno do Supabase `.162`.
