...
**Prioridade vigente — atualização de 17/09/2026:** acompanhar por read-back cada operação real. O ciclo completo da venda `2000018462600932`, o SHA ativo, a release e o executor único atual foram comprovados; para fechar o marco 7 ainda falta evidência do acompanhamento diário inicial, inclusive 12/09. Ver [conferência do marco 7](evidencias/BNT-MARCO-7-OPERACAO-01-validacao.md). Criação em lote, Assistente, Oráculo e automação própria permanecem em seus gates. O limite de custo de R$ 3.000 foi conferido no banco; a coorte associada ainda exige validação e aceite próprios.
...
| 7 — Bentevi em operação | Em andamento desde 09/09/2026; ciclo real, versão e executor atual comprovados | Comprovar acompanhamento diário inicial, inclusive 12/09 | Conferir os registros operacionais faltantes; manter read-back das sincronizações reais | Venda, nota, compra, etiqueta, envio, entrega, SHA ativo, release e executor único confirmados; atividade histórica dos dias 09–16 não equivale a monitoramento diário; [evidência](evidencias/BNT-MARCO-7-OPERACAO-01-validacao.md) |
...
- [ ] acompanhamento diário dos primeiros sete dias do marco 7 comprovado; falta registro de observação operacional de 12/09 e a atividade histórica reconstruída não substitui essa prova;
