...
| 7 — Bentevi em operação | Em andamento desde 09/09/2026; um ciclo real completo comprovado em 17/09 | Comprovar acompanhamento diário inicial, executor único atual e SHA da imagem ativa | Conferir registros operacionais faltantes; manter read-back das sincronizações reais | Venda, nota, compra, etiqueta, envio e entrega confirmados; atividade histórica dos dias 09–16 reconstruída, sem equivaler a monitoramento diário; [evidência](evidencias/BNT-MARCO-7-OPERACAO-01-validacao.md) |
...
- [ ] marco 7 registrado com versão ativa comprovada, horário, executor único atual e acompanhamento diário dos primeiros sete dias; a atividade histórica reconstruída não comprova observação diária;
- [ ] release registrada;
