...
A implementação da liquidação consolidada de fornecedores é acompanhada no checklist dedicado [VORTEK_ORACULO_FORNECEDORES_CHECKLIST.md](VORTEK_ORACULO_FORNECEDORES_CHECKLIST.md). `ORC-00` e `ORC-01 — Schema aditivo` foram aceitas em 16/09/2026. `ORC-02 — Estados e elegibilidade` foi aceita tecnicamente em 16/09/2026 após publicação e smoke. `ORC-03 — Núcleo financeiro transacional` foi aceita tecnicamente em 16/09/2026: SHA funcional `64d576bc527d3e35dc29fd971655376e1de8a140` promovido por fast-forward, migration `20260916193000` aplicada em `.162`, imagem do deploy comprovada no contêiner ativo e read-back sem registros financeiros novos. `ORC-04 — Pós-processamento e comunicação` foi aceita tecnicamente em 16/09/2026: SHA funcional `5a115dbe9873fe76f9d0fd928524c213028a097c` promovido por fast-forward, migration `20260916210000` aplicada em `.162`, imagem do deploy comprovada no contêiner ativo e read-back sem novos registros. A flag de escrita segue desligada; as 22 compras PIX pendentes permanecem com abastecimento `unknown`, e o preview autenticado com dados reais ainda não foi exercitado. `ORC-05 — Interfaces operacionais` é a próxima ação técnica, em tarefa própria. Nenhum pagamento em lote, backfill financeiro, envio WhatsApp, retomada DSLite real ou ativação foi executado. Executar uma ação por tarefa e manter no checklist dedicado as evidências, SHAs, migrations, testes, publicação e aceite.
