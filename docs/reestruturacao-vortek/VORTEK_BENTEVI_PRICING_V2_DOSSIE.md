...
Migration `20260907213000` aplicada somente em `.162`, tipos gerados, SQL/concorrência e testes locais validados. Falta homologar pesquisa/interface. Decisão de 07/09/2026: executar primeiro `BNT-AI-PROVIDER-01`, sem exigir chave OpenRouter antes do piloto; Firecrawl DEV permanece necessário à coleta atual. O piloto preserva os contratos da garantia e não substitui seu aceite. Não confundir aceite visual anterior de override/liquidação com homologação comercial; guard continua bloqueado. Sequência: integração/teste → concluir garantia → V2-08 / CFL-04 — Buy Box econômica. O futuro chat reutilizará a evidência da integração, sem antecipar sua implementação.
