...
| WAHA/WhatsApp | `WAHA_BASE_URL`, `WAHA_URL`, `WAHA_API_KEY`, `WAHA_SESSION`, `WAHA_TEST_RECIPIENT_PHONE`, `WHATSAPP_ALERT_PHONES` | integração controlada; chave write-only; destinatários migram para tabela tipada |
