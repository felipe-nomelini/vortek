...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: colors.background, borderColor: colors.border, borderRadius: 8, borderWidth: 1, color: colors.text, paddingHorizontal: 12, paddingVertical: 11 }, notes: { minHeight: 72, textAlignVertical: "top" }, primaryButton: { alignItems: "center", backgroundColor: colors.primary, borderRadius: 8, padding: 12 }, primaryText: { color: colors.text, fontWeight: "700" }, secondaryButton: { alignItems: "center", borderColor: colors.primary, borderRadius: 8, borderWidth: 1, padding: 11 }, secondaryText: { color: "#8fc2ff", fontWeight: "700" }, success: { color: colors.success, fontSize: 12, textAlign: "center" }, error: { color: colors.danger, fontSize: 12, textAlign: "center" }, errorCard: { backgroundColor: colors.surface, borderColor: colors.danger, borderRadius: 12, borderWidth: 1, gap: 12, padding: 16 },
});
