...
const styles = StyleSheet.create({
  ...
  chip: { borderColor: colors.border, borderRadius: 16, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 7 }, chipActive: { backgroundColor: colors.primary, borderColor: colors.primary }, chipText: { color: colors.textMuted, fontSize: 11 }, chipTextActive: { color: colors.textOnPrimary, fontSize: 11, fontWeight: "700" },
  primaryButton: { alignItems: "center", backgroundColor: colors.primary, borderRadius: 8, padding: 12 }, primaryText: { color: colors.textOnPrimary, fontWeight: "700" },
